...
export const services = [
  {
    ...
    workflowLabels: ["Assess", "Translate", "Build", "Handover", "Support"],
    capabilities: [
  ...
  },
  {
    ...
    workflowLabels: ["Discover", "Design", "Build", "Launch"],
    capabilities: [
  ...
  },
  {
    ...
    workflowLabels: ["Assess", "Design", "Implement", "Document"],
    capabilities: [
      { label: "Tenant", icon: Cloud },
